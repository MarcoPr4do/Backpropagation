...
posible_test_text = Label(text="resultado posible *", )
...
posible_test_text.place(x=15, y=670)

media_del_radio = DoubleVar(value=7.76)
textura_media = DoubleVar(value=24.54)
media_del_perímetro = DoubleVar(value=47.92)
media_del_área = DoubleVar(value=181)
suavidad_significa = DoubleVar(value=0.05263)
compacidad_significa = DoubleVar(value=0.04362)
media_de_concavidad = DoubleVar(value=0)
puntos_cóncavos_significan = DoubleVar(value=0)
simetría_media = DoubleVar(value=0.1587)
media_de_la_dimensión_fractal = DoubleVar(value=0.05884)
radio_se = DoubleVar(value=0.3857)
textura_se = DoubleVar(value=1.428)
perímetro_se = DoubleVar(value=2.548)
area_se = DoubleVar(value=19.15)
suavidad_se = DoubleVar(value=0.007189)
compacidad_se = DoubleVar(value=0.00466)
concavidad_se = DoubleVar(value=0)
puntos_concavos_se = DoubleVar(value=0)
simetría_se = DoubleVar(value=0.02676)
dimension_fractal_se = DoubleVar(value=0.002783)
radio_peor = DoubleVar(value=9.456)
textura_peor = DoubleVar(value=30.37)
perímetro_peor = DoubleVar(value=59.16)
zona_peor = DoubleVar(value=268.6)
suavidad_peor = DoubleVar(value=0.08996)
compacidad_peor = DoubleVar(value=0.06444)
peor_concavidad = DoubleVar(value=0)
puntos_concavos_peor = DoubleVar(value=0)
simetria_peor = DoubleVar(value=0.2871)
dimension_fractal_peor = DoubleVar(value=0.07039)
posible_test = DoubleVar(value=0)
...
posible_test_entry = Entry(textvariable=posible_test)
...
posible_test_entry.place(x=195, y=670)
...
def save_info():
    ...
    inputs = []
    inputs.append(media_del_radio.get())
    inputs.append(textura_media.get())
    inputs.append(media_del_perímetro.get())
    inputs.append(media_del_área.get())
    inputs.append(suavidad_significa.get())
    inputs.append(compacidad_significa.get())
    inputs.append(media_de_concavidad.get())
    inputs.append(puntos_cóncavos_significan.get())
    inputs.append(simetría_media.get())
    inputs.append(media_de_la_dimensión_fractal.get())
    inputs.append(radio_se.get())
    inputs.append(textura_se.get())
    inputs.append(perímetro_se.get())
    inputs.append(area_se.get())
    inputs.append(suavidad_se.get())
    inputs.append(compacidad_se.get())
    inputs.append(concavidad_se.get())
    inputs.append(puntos_concavos_se.get())
    inputs.append(simetría_se.get())
    inputs.append(dimension_fractal_se.get())
    inputs.append(radio_peor.get())
    inputs.append(textura_peor.get())
    inputs.append(perímetro_peor.get())
    inputs.append(zona_peor.get())
    inputs.append(suavidad_peor.get())
    inputs.append(compacidad_peor.get())
    inputs.append(peor_concavidad.get())
    inputs.append(puntos_concavos_peor.get())
    inputs.append(simetria_peor.get())
    inputs.append(dimension_fractal_peor.get())
    outputs = []
    outputs.append(posible_test.get())
    inputs_data = []
    outputs_data = []
    outputs_data.append(inputs)
